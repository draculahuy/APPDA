...
const  Tintuc = ({navigation}) => {
    ...
    return(
        <View style={{ flex: 1}}>
            <View style={{ backgroundColor: '#0099FF', color: 'white', height: 50, width: '100%', paddingLeft: 10,justifyContent:'center', alignItems: 'center', flexDirection: 'row' }}>
                <TouchableOpacity onPress={() => {
                    navigation.navigate('MyTabs');
                }}>
                    <Image source={require('../../images/back.png')} style={{ height: 25, width: 25, marginRight: 20 }} />
                </TouchableOpacity>
                <Text style={{width:screenWidth-100,fontSize:25, color:'white', fontWeight:'bold', justifyContent:'center'}}>Tin tức</Text>
